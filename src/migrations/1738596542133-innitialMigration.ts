...
export class InnitialMigration1738596542133 implements MigrationInterface {
    name = 'InnitialMigration1738596542133'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "imagesUrl" text DEFAULT '', "description" text NOT NULL, "animalType" "public"."post_animaltype_enum" NOT NULL, "animalSizes" text array NOT NULL DEFAULT '{}', "userId" integer, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
